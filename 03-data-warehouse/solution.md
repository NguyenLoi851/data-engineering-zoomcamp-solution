...
```bash
SELECT PULocationID AS distinct_pu_locations
FROM `kestra-study.kestra_study_dataset_xyz.yellow_tripdata_2024_01_06_native`;

SELECT PULocationID, DOLocationID AS distinct_pu_locations
FROM `kestra-study.kestra_study_dataset_xyz.yellow_tripdata_2024_01_06_native`;
...
```bash
SELECT COUNT(*) FROM `kestra-study.kestra_study_dataset_xyz.yellow_tripdata_2024_01_06_partition_cluster`;
